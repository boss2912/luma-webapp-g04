...
> **⭐ หยิบ issue ไหนก่อน** → [`../../docs/START_1_WEB.md`](../../docs/START_1_WEB.md) — คิวงานเรียงลำดับ + งานวันแรก
> · [issue ที่ติด label `area:frontend`](https://github.com/boss2912/luma-webapp-g04/issues?q=is%3Aissue+is%3Aopen+label%3Aarea%3Afrontend)
