...
>
> โค้ดตัวจริงยังอยู่ใน git ด้วย — ดูได้จาก tag **`backup/v1-final`**
> (อย่าใช้ `backup/pre-restructure-develop` — ชี้ไปที่ commit ก่อน merge 3 PR จึงไม่มี security fix)
